...
print(timeit('re_test(lines)', 'from __main__ import re_test, lines', number = 10))
print(timeit('lxml_test(xml)', 'from __main__ import lxml_test, xml', number = 10))
re_list = re_test(lines)
lxml_list = lxml_test(xml)
print(re_list == lxml_list)
